""" initialisation des classes dans app.py

Revision ID: 5e0342a73739
Revises: 
Create Date: 2026-08-20 13:50:53.054804
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['id_auteur'], ['user.id'], ),
    sa.ForeignKeyConstraint(['id_categorie'], ['category.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('slug')
    )
